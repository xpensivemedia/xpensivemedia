...
export default function Showcase() {
  ...
  const categories = [
    ...
    //{ key: 'decor-interiors', label: 'Decor & Interiors', icon: 'home' },
    //{ key: 'temples', label: 'Temples', icon: 'place-of-worship' },
    //{ key: 'brand-promotions', label: 'Brand Promotions', icon: 'bullhorn' },
    //{ key: 'education', label: 'Education Shoots', icon: 'graduation-cap' },
